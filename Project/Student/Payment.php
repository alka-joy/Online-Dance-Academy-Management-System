...
<body>
    ...
    if($_POST["btns"])
    {
        $up="update tbl_admission set admission_status=1,payment_date=curdate() where admission_id='".$_GET["did"]."'";
        if(mysql_query($up))
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <table cellspacing="20">
                                    ...
                                    <tr>
                                        <td>Name</td>
                                        <td colspan="3"><input type="text" name="txtname" required="required" autocomplete="off"  title="Enter Correct Name" minlength="3" placeholder="Name" style="width: 185px;" class="text-box"></td>
                                    </tr>
                                    <tr>
                                        <td>Exp Date</td>
                                        <td><input style="width: 50px;" id="credit-card-exp" type="text" name="txtexpdate" required="required" autocomplete="off" placeholder="XX/XXXX" pattern="(0[1-9]|1[0-2])\/[0-9]{2}"  title="Enter Correct Date" minlength="5" maxlength="5" class="text-box"></td>
                                        <td>CCV</td>
                                    ...
                                    <tr><td colspan="4" align="center"><input type="submit" value="Make Payment" class="button-pay" name="btns"></td></tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
