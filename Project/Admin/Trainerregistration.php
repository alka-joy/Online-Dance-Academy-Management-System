...
if(isset($_POST["button"]))
{
	...
	$ins="insert into tbl_trainer(trainer_name,trainer_contact,trainer_email,trainer_photo,trainer_certificate,trainer_video,trainer_password,subcategory_id,trainer_status)values('".$name."','".$contact."','".$email."','".$photo."','".$certificate."','".$video."','".$password."','".$subcat."','1')";
	//mysql_query($ins);
	echo $ins;
    if(mysql_query($ins))
	{
